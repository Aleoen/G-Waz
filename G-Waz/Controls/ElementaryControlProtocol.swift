...
protocol ElementaryControl: SKSpriteNode {
    ...
    static func setupForElementaryControl(fileNamed: String, with color: SKColor?, and label: String) -> ElementaryControl
...
extension ElementaryControl {
    ...
    static func setupForElementaryControl(fileNamed: String, with color: SKColor?, and label: String) -> ElementaryControl {
        ...
        control.specificSetupForElementaryControl(with: label, with: color)
        return control
    }
